...
#ifndef MODULE_PERCEPTION_PLANNING_LOCALIZATION_AMCL_PARTICLE_FILTER_PATICLE_FILTER_KDTREE_H
#define MODULE_PERCEPTION_PLANNING_LOCALIZATION_AMCL_PARTICLE_FILTER_PATICLE_FILTER_KDTREE_H
...
class ParticleFilterKDTree {
 public:
   ...
   */
  void InsertPose(math::Vec3d pose, double value);
  /**
   ...
   */
  int GetCluster(math::Vec3d pose);
  /**
 ...
 private:
  ParticleFilterKDTreeNode *InsertNode(ParticleFilterKDTreeNode *parent_node_ptr,
                                       ...
                                       const math::Vec3d &key,
                                       double value);
  ParticleFilterKDTreeNode *FindNode(ParticleFilterKDTreeNode *node_ptr, math::Vec3d key);
  inline bool IsEqualKey(const math::Vec3d &key_a, const math::Vec3d &key_b);
...
#endif //MODULE_PERCEPTION_PLANNING_LOCALIZATION_AMCL_PARTICLE_FILTER_PATICLE_FILTER_KDTREE_H
