 ...
 ***************************************************************************/
#ifndef MODULES_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
#define MODULES_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H

#include "modules/planning/global_planner/a_star_planner/proto/a_star_planner_config.pb.h"

#include "common/algorithm_factory.h"
#include "common/error_code.h"
#include "common/log.h"

#include "modules/planning/global_planner/global_planner_base.h"
...
class AStarPlanner : public GlobalPlannerBase {
 ...
 public:
   ...
   */
  rrts::common::ErrorInfo Plan(const geometry_msgs::PoseStamped &start,
 ...
 private:
   ...
   * @return ErrorInfo which is OK if succeed
   */
  rrts::common::ErrorInfo SearchPath(const int &start_index,
   ...
   * @return ErrorInfo which is OK if succeed
   */
  rrts::common::ErrorInfo GetMoveCost(const int &current_index,
...
#endif // MODULES_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
