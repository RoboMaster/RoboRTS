 ...
 ***************************************************************************/
#ifndef MODULES_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
#define MODULES_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
...
#include "modules/planning/global_planner/proto/global_planner_config.pb.h"
#include "modules/planning/global_planner/global_planner_algorithms.h"
...
class GlobalPlannerNode : public rrts::common::RRTS {
 ...
 private:
   ...
   */
  void GoalCallback(const messages::GlobalPlannerGoal::ConstPtr &msg);
  /**
   * @brief Set the state for planning module
   * @param node_state Enumerate State for global planning
   */
  void SetNodeState(rrts::common::NodeState node_state);
  /**
...
#endif //MODULES_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
