...
#ifndef MODULES_DRIVER_SERIAL_SERIAL_COMM_H
#define MODULES_DRIVER_SERIAL_SERIAL_COMM_H
...
class SerialComm : public rrts::common::RRTS {
 ...
 private:
/**
 * @brief Set the serial port boudrate
 * @param boudrate The value to set
 */
  void ConfigBoudrate(int boudrate);
};
} //namespace serial
} //namespace driver
} //namespace rrts
#endif //MODULES_DRIVER_SERIAL_SERIAL_COMM_H
